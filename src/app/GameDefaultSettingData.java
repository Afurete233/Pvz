...
public class GameDefaultSettingData {

    public static int GAME_WIN_WIDTH = 1280;
    public static int GAME_WIN_HEIGHT = 720;
    public static String GAME_TITLE = "PVZ";
    public static String[] communication_data = { "赶快开始战斗吧", "不要再戳了", "你的任务还有很多" };
